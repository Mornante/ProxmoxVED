...
# upstream   https://github.com/Mornante/ProxmoxVED.git (fetch)
# upstream   https://github.com/Mornante/ProxmoxVED.git (push)
```
...
print_info "Upstream: https://github.com/Mornante/ProxmoxVED"
echo ""
